...
module VagrantPlugins
  module HyperV
    module Action
      # This action connects to a HyperV server, verifies credentials work, and
      # puts the HyperV connection object into the `:hyperv_compute` key
      # in the environment.
      class ConnectHyperV
        def initialize(app, env)
          @app    = app
          @logger = Log4r::Logger.new("vagrant_hyperv::action::connect_hyperv")
        end
        ...
        def call(env)
          ...
          @logger.info("Connecting to HyperV...")
